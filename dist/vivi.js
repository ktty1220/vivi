...
})(this);// Generated by CoffeeScript 1.8.0
...
(function() {
  var Core, Scrollbar, Section, ViVi, _base, _elBody, _hardwareScroll, _scrollbar,
  ...
  _hardwareScroll = {
    duration: (function(_this) {
      return function(el, ms, opt) {
        ...
        return el.style.transition = "" + opt + "transform " + tr;
      };
    })(this),
    set: (function(_this) {
  ...
  Scrollbar = (function() {
    function Scrollbar(top) {
      ...
      this.timer = setInterval((function(_this) {
        return function() {
          ...
          if (--_this.visibleRemain <= 0) {
            _this.el.style.opacity = 0;
            return _this.show = false;
          }
        };
      })(this), 1000);
      document.addEventListener('sectionactive', (function(_this) {
        return function(ev) {
          var el;
          el = ev.target;
          return _this.setPos(el, _hardwareScroll.get(el).y, 0, true);
        };
      })(this));
      document.addEventListener('sectionbackground', (function(_this) {
        return function(ev) {
          var el;
    ...
    Scrollbar.prototype.hide = function(resetPos) {
      if (resetPos == null) {
        resetPos = false;
      }
      this.show = false;
    ...
    Scrollbar.prototype.setEl = function(el) {
      var oh;
      if ((el != null) && this.currentEl !== el) {
        this.currentEl = el;
        this.height = el.parentNode.offsetHeight;
        oh = el.offsetHeight;
        if (this.height >= oh) {
          return;
        }
        return this.el.style.height = "" + (Math.max(6, (this.height / oh) * this.height)) + "px";
      }
    };

    Scrollbar.prototype.moveBar = function(y, duration) {
      if (y == null) {
        y = 0;
      }
      if (duration == null) {
      ...
      return _hardwareScroll.set(this.el, 0, y);
    };

    Scrollbar.prototype.setDuration = function(duration) {
      return _hardwareScroll.duration(this.el, duration, 'opacity 600ms ease-out');
    };

    Scrollbar.prototype.setPos = function(el, y, duration, bg) {
      var oh;
      if (bg == null) {
        bg = false;
      }
      ...
      this.moveBar((y / oh) * this.height, duration);
      if (!bg) {
        return this.visibleRemain = 2;
      }
    };
  ...
  ViVi = (function() {
    ...
    ViVi.prototype._setTranslate3d = function(el, x, y) {
      ...
      return _hardwareScroll.set(el, x, y);
    };

    ViVi.prototype._currentTransform = function(el) {
      return _hardwareScroll.get(el);
    };
  ...
  Section = (function(_super) {
    ...
    Section.prototype._createCheckBox = function() {
      ...
      return this.each('.vv-page .list-item-checkbox', (function(_this) {
        return function(el, i) {
          var children;
          if (_this.find('.vv-checkbox', el).length > 0) {
            return;
          }
    ...
    Section.prototype._onPageDrag = function(ev) {
      var altVelocity, b, deltaHistory, deltaTime, deltaY, direction, duration, el, elWrapper, maxBottom, pos, scrollRange, velocityY, y, _i, _len, _ref, _ref1, _ref2;
  ...
  Core = (function(_super) {
    ...
    function Core() {
      ...
      this.getActiveArticle = __bind(this.getActiveArticle, this);
      this.getActiveSection = __bind(this.getActiveSection, this);
      this.refreshScrollbar = __bind(this.refreshScrollbar, this);
      this.hideScrollbar = __bind(this.hideScrollbar, this);
      ...
      return document.addEventListener(trigger, (function(_this) {
        return function() {
          return _this.initialize(function() {
            ...
            _this.section['vv-main'].actived = 1;
            _scrollbar = new Scrollbar(_this.section['vv-main'].find('.vv-wrapper')[0].offsetTop);
    ...
    Core.prototype._onSectionChanged = function(elt) {
      ...
      if (this.hasClass(elt, 'back')) {
        ...
        for (k in _ref) {
          v = _ref[k];
          this.removeClass(v.el, 'active');
        }
        this.addClass(elt, 'active');
        this.section[elt.id].actived = parseInt(new Date() / 1000, 10);
        return this.fireEvent('sectionactive', elt);
      }
    };

    Core.prototype._doSectionChange = function(elSection) {
      if (this.hasClass(elSection, 'active')) {
        return;
      }
      _scrollbar.hide();
    ...
    Core.prototype.hideScrollbar = function(resetPos) {
      if (resetPos == null) {
        resetPos = false;
      }
      return _scrollbar.hide(resetPos);
    };

    Core.prototype.refreshScrollbar = function() {
      return _scrollbar.refresh();
    };

    Core.prototype.getActiveSection = function() {
      return this.find('body>section.active').item(0);
    };

    Core.prototype.getActiveArticle = function() {
      var currentSection, tabs;
      currentSection = this.getActiveSection();
      tabs = this.find('nav li.active a', currentSection);
      if (tabs.length === 0) {
        return this.find('article', currentSection).item(0);
      }
      return this.find(tabs.item(0).getAttribute('href'), currentSection).item(0);
    };
    ...
    Core.prototype.closeSection = function(toLeft) {
      ...
      this.section[currentSection.id].actived = 0;
      ...
      return (function(_this) {
        return function(currentSection) {
          return setTimeout(function() {
            ...
            for (k in _ref) {
              v = _ref[k];
              if (v.actived > 0 && ((nextSection == null) || nextSection.actived < v.actived)) {
                nextSection = v;
              }
            }
    ...
    Core.prototype._sectionEvent = function() {
      return this.event.tap(this.find('header .vv-back'), (function(_this) {
        return function(ev) {
          if (_this.find('body>section.standby').length > 0) {
            return;
          }
          return _this.closeSection();
        };
    ...
    Core.prototype.changeTab = function(tabId) {
      return this.section[this.getActiveSection().id].changeTab(tabId);
    };
