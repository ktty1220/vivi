...
なお、現在ViViに組み込まれているHammer.jsのバージョンは1.0.6ですが、Hammer.jsの最新バージョンを使用するとスクロールの動作がおかしくなる現象が確認されています。1.0.6以上のバージョンには上げないようにしてください。

## Changelog

### 0.1.3 (2014-09-15)

* closeSection()の動作中に発生した別のcloseSection()は無視するように修正
